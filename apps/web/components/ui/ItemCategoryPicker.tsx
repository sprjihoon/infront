    ...
    <>
      ...
      >
        <span className={selected ? "text-gray-900 font-medium" : "text-gray-400"}>
          {selected ? selected.name_ko : "?àÎ™© ?†ÌÉù (Í≤Ä??Í∞Ä??"}
        </span>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex flex-col justify-end items-center">
          ...
          {/* ?úÌä∏ */}
          <div className="relative w-full max-w-[600px] bg-white rounded-t-3xl max-h-[80vh] flex flex-col shadow-2xl">
            {/* ?§Îçî */}
            <div className="px-4 pt-4 pb-2">
              <div className="w-10 h-1 bg-gray-200 rounded-full mx-auto mb-4" />
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-base font-bold text-gray-900">?àÎ™© ?†ÌÉù</h3>
                <button
                  onClick={() => { setOpen(false); setQuery(""); }}
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="?àÎ™©Î™??êÎäî HSÏΩîÎìú Í≤Ä??
            ...
            <div className="overflow-y-auto flex-1 pb-safe">
              {Object.entries(grouped).length === 0 ? (
                <div className="py-10 text-center text-sm text-gray-400">Í≤Ä??Í≤∞Í≥ºÍ∞Ä ?ÜÏñ¥??/div>
              ) : (
