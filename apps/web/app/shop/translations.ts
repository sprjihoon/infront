...
export const t = {
  ko: {
    ...
    paymentNotice: "결제는 엑심베이(Eximbay)를 통해 안전하게 처리됩니다",
    sdkLoading: "결제 모듈을 불러오는 중입니다. 잠시 후 다시 시도해 주세요.",
    payFail: "결제 준비에 실패했습니다.",
    payError: "결제 초기화에 실패했습니다.",

    /* success/fail */
    verifying: "결제 확인 중...",
    verifyingDesc: "잠시만 기다려주세요",
    paymentFailed: "결제 실패",
    paymentDone: "결제 완료!",
    paymentDoneDesc: "포장대행 서비스 결제가 완료되었습니다.\n빠른 시일 내에 처리해 드리겠습니다.",
    orderNo: "주문번호",
    paidAmount: "결제금액",
    continueShopping: "쇼핑 계속하기",
    backToList: "상품 목록으로",
    retry: "다시 시도",
    supportNotice: "문제가 지속되면 고객센터로 문의해 주세요.",
  ...
  en: {
    ...
    paymentNotice: "Payment is securely processed via Eximbay.",
    sdkLoading: "Loading payment module. Please try again in a moment.",
    ...
    paymentDoneDesc: "Your packaging service payment is confirmed.\nWe will process your order as soon as possible.",
    orderNo: "Order No.",
    paidAmount: "Amount Paid",
    continueShopping: "Continue Shopping",
    backToList: "Back to Products",
    retry: "Try Again",
    supportNotice: "If the issue persists, please contact customer support.",
