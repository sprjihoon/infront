...
export const FOREIGN_CARD_SCOPE_NOTICE_KO =
  "해외카드는 수거비, 검품비, 포장비, 국내배송비, 해외배송비 등 단건 서비스 이용요금 결제에 사용할 수 있습니다. 장기보관 월 이용료는 별도 자동결제 빌링 구조로 운영됩니다.";

export const FOREIGN_CARD_SCOPE_NOTICE_EN =
  "International cards may be used for one-time service fees (pickup, inspection, packing, domestic/international shipping). Monthly long-term storage fees are billed separately via card auto-payment.";
...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  },
  {
    id: "PICKUP_FEE",
    category: "pickup",
    paymentItemKey: "pickup_fee",
    name: "수거비",
    nameEn: "Pickup Fee",
    price: 5000,
    billingType: "one_time",
    description: "고객 지정 국내 주소에서 물품을 수거하는 서비스입니다.",
    descriptionEn: "Pickup service from your designated domestic address.",
    deliveryMethod: "지정 주소 방문 수거",
    deliveryMethodEn: "Door-to-door pickup",
    servicePeriod: "결제 완료 후 1~2영업일 내 수거",
    servicePeriodEn: "Pickup within 1–2 business days after payment",
    refundNote: "수거가 시작된 이후 수거비 환불 제한",
    refundNoteEn: "Pickup fee non-refundable after pickup begins",
    icon: "truck",
    badge: "수거",
    badgeEn: "Pickup",
  ...
  },
  {
    ...
    name: "국내배송비",
    nameEn: "Domestic Shipping Fee",
    price: 3500,
    billingType: "one_time",
    description: "국내 택배·우편을 통해 물품을 발송하는 서비스입니다.",
    descriptionEn: "Domestic parcel/post shipping service.",
    deliveryMethod: "국내 택배/우편",
    deliveryMethodEn: "Domestic courier/post",
    servicePeriod: "출고 요청 및 결제 완료 후 통상 1~3영업일",
    servicePeriodEn: "Typically 1–3 business days after dispatch request and payment",
    refundNote: "배송 접수 또는 운송장 발급 이후 배송비 환불 제한",
    refundNoteEn: "Shipping fee non-refundable after dispatch or waybill issuance",
    icon: "box",
    badge: "국내",
    badgeEn: "Domestic",
  ...
  },
  {
    id: "INTL_SHIPPING",
    category: "intl",
    paymentItemKey: "international_shipping_fee",
    name: "해외배송비",
    nameEn: "International Shipping Fee",
    price: 25000,
    billingType: "one_time",
    description: "EMS·EMS Premium·K-Packet 등으로 해외 배송을 진행하는 서비스입니다.",
    descriptionEn: "International shipping via EMS, EMS Premium, or K-Packet.",
    deliveryMethod: "EMS / EMS Premium / K-Packet",
    deliveryMethodEn: "EMS / EMS Premium / K-Packet",
    servicePeriod: "국가 및 배송수단에 따라 통상 3~15영업일",
    servicePeriodEn: "Typically 3–15 business days depending on country and carrier",
    refundNote: "배송 접수 또는 운송장 발급 이후 배송비 환불 제한",
    refundNoteEn: "Shipping fee non-refundable after dispatch or waybill issuance",
    intlTrackingNote: INTL_TRACKING_NOTE_KO,
    intlTrackingNoteEn: INTL_TRACKING_NOTE_EN,
    icon: "globe",
    badge: "해외",
    badgeEn: "Intl",
  ...
  },
  {
    ...
    name: "검품/포장 서비스",
    nameEn: "Inspection & Packaging Service",
    price: 8000,
    billingType: "one_time",
    description: "물류센터에서 물품 상태 확인 및 안전 포장을 진행하는 서비스입니다.",
    descriptionEn: "Item inspection and safe packaging at our logistics center.",
